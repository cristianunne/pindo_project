...
Router::scope('pindo_project/Empresa/', function ($routes) {

    Router::connect('Empresa/ver/*', ['controller' => 'Empresa', 'action' => 'index']);
    Router::connect('Empresa/editar/*', ['controller' => 'Empresa', 'action' => 'edit']);
