...
class Pindo7 extends AbstractMigration
{
    public function up()
    {
        ...
        $this->table('inventario', ['id' => false, 'primary_key' => ['idinventario']])
            ...
            ->addColumn('vol_medio', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('vol_total', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('area_basal', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
        ...
        $this->table('plantaciones', ['id' => false, 'primary_key' => ['nro_plantacion']])
            ...
            ->addColumn('dist_lineas', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('dist_plantas', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('num_arbol_plantado', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => true,
            ])
            ->addColumn('sobrevivencia', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
        ...
        $this->table('variables_generales', ['id' => false, 'primary_key' => ['idvariablesgenerales']])
            ...
            ->addColumn('duracion_turnos_hs', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('turnos_dia', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => true,
            ])
            ->addColumn('dias_por_semana', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => true,
            ])
            ->addColumn('dias_por_mes', 'integer', [
                'default' => null,
                'limit' => 10,
                'null' => true,
            ])
            ->addColumn('margen_ganancia', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
            ->addColumn('factor_ajuste', 'float', [
                'default' => null,
                'limit' => null,
                'null' => true,
            ])
