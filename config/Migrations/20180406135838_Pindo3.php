...
class Pindo3 extends AbstractMigration
{
    public function up()
    {
        ...
        $this->table('varables_generales', ['id' => false, 'primary_key' => ['idvariablesgenerales']])
    ...
    public function down()
    {
        ...
        $this->dropTable('varables_generales');
    }
}
