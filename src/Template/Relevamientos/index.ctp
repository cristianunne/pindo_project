                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="middle">
                                            ...
                                            <?= $this->Html->link($this->Html->tag('span', '', ['class' => 'glyphicon glyphicon-search', 'aria-hidden' => 'true']),
                                                ['controller' => 'Relevamientos', 'action' => 'parcelasView', '?' => ['Accion' => 'Ver Relevamientos', 'Categoria' => 'Relevamientos',
                                                    'id' => $rodal->idrodales, 'sap' => $rodal->cod_sap]], ['class' => 'btn btn-success', 'escape' => false]) ?>
                                        </td>
                                    </tr>
