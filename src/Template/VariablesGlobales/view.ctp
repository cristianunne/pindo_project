...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?= $this->Form->create($variablesGlobales, ['id' => 'myform']) ?>
                    ...
                    <table class="table" style="width: 0%;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <?= $this->Form->input('tasa_int_cap_propio', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'tasa_int_cap_propio']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="ausentismo">Ausentismo (%):</label></td>

                                <td> <?= $this->Form->input('ausentismo', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'ausentismo']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="margen_ganancia">Margen de ganancia (%):</label></td>

                                <td> <?= $this->Form->input('margen_ganancia', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'margen_ganancia']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="costo_administrativo">Costos administrativos (%):</label></td>

                                <td> <?= $this->Form->input('costo_administrativo', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'costo_administrativo']) ?> </td>
                            </tr>
                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="contador_publico">Costo del contador público (%):</label></td>

                                <td> <?= $this->Form->input('contador_publico', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'contador_publico']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="impuestos_totales">Impuestos sobre el costo final (%):</label></td>

                                <td> <?= $this->Form->input('impuestos_totales', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'impuestos_totales']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="tasa_seguro">Tasa de seguro anual (%):</label></td>

                                <td> <?= $this->Form->input('tasa_seguro', ['class' => 'form-control', 'label' => false, 'required','disabled' => True, 'id' => 'tasa_seguro']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="traslado_personal">Traslado de personal (km/mes):</label></td>

                                <td> <?= $this->Form->input('traslado_personal', ['class' => 'form-control', 'label' => false, 'required', 'disabled' => True, 'id' => 'traslado_personal']) ?> </td>
                            </tr>

                            <tr>
                                <td class="row-label" style="vertical-align: middle;" > <label for="dias_mes">Dias por mes (días):</label></td>

                                <td> <?= $this->Form->input('dias_mes', ['class' => 'form-control', 'label' => false, 'required', 'disabled' => True, 'id' => 'dias_mes']) ?> </td>
                            </tr>
