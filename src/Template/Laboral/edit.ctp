...
<div class="content-wrapper" xmlns:text-align="http://www.w3.org/1999/xhtml"
    ...
    <section class="content">
        <div class="row">
            <?= $this->Form->create($laboral, ['id' => 'myform']) ?>
            ...
            <div class="col-md-6" style="float: none; margin: 0 auto">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Editar Datos Laborales</h3>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <?= $this->Html->link('Volver', ['controller' => 'Laboral', 'action' => 'index', '?' => ['Accion' => 'Ver Datos Laborales', 'Categoria' => 'Laboral']],
