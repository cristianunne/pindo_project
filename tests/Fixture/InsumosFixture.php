...
class InsumosFixture extends TestFixture
{
    ...
    public $fields = [
        'idinsumos' => ['type' => 'integer', 'length' => 10, 'autoIncrement' => true, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null],
        ...
        'precio_espada' => ['type' => 'float', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null],
        'precio_cadena' => ['type' => 'float', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null],
        ...
        'pantalon_seguridad' => ['type' => 'float', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null],
        ...
        'movil_traslado_costo' => ['type' => 'float', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['idinsumos'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            ...
            'casco_chaleco' => 1,
            'pantalon_seguridad' => 1,
            'alojamiento_dia_persona' => 1,
            'vianda_dia' => 1,
            'movil_traslado_costo' => 1
        ],
    ];
}
